...
namespace AdvancedProgramming_Lesson1.Controllers
{
    public class BooksController : Controller
    {
        ...
        {
            ViewData["AuthorId"] = new SelectList(_context.Authors, "Id", "CountryOfOrigin");
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,YearOfRelease,GenreId,AuthorId,PagesCount,ListPrice")] Book book)
        {
            ...
            ViewData["AuthorId"] = new SelectList(_context.Authors, "Id", "CountryOfOrigin", book.AuthorId);
            ViewData["GenreId"] = new SelectList(_context.Genres, "Id", "Themes", book.GenreId);
            return View(book);
        }
